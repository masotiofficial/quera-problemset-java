...
public class P0033037 {
    ...
    public static void main(String[] args) {
        ...
        P0033037 solution = new P0033037();
        List<P0033037.ExceptionProxy> result = solution.transformException(functions);
        for(P0033037.ExceptionProxy exceptionProxy: result) {
